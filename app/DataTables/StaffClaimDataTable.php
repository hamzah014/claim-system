...
class StaffClaimDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('reference_no', function ($model) {
                $viewUrl = route('claims.edit', $model->id);
            ...
            ->addColumn('action', function ($model) {
                ...
                if(in_array($model->status, ['draft','pending'])) {
                    $show .= '
                        <a class="btn btn-danger btn-sm" href="'.$deleteUrl.'">Withdraw</a>
                    ';
                }

                return $show;
            })
            ->rawColumns(['reference_no','duty_date','created_at','action']);
    }
