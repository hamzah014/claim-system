...
@section('title', 'Staff Login - Secure Access')
...
@section('content')
    ...
    <div class="p-10 space-y-8 transition duration-300 ease-in-out bg-white border border-gray-100 shadow-xl dark:bg-gray-800 rounded-2xl hover:shadow-2xl dark:border-gray-700">
        ...
        <header class="space-y-2 text-center">
            <div class="flex items-center justify-center w-12 h-12 mx-auto bg-indigo-500 rounded-full shadow-lg">
        ...
        <form action="{{ route('login.auth') }}" method="post" class="space-y-6">
            ...
            {{-- Email field --}}
            <div>
                <label for="email" class="block mb-1 text-sm font-semibold text-gray-700 dark:text-gray-300">Email Address</label>
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" 
                           class="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg placeholder-gray-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white 
                                  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 text-sm
            ...
            {{-- Submit Button --}}
            <div class="pt-4">
                <button type="submit" class=" w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-lg text-base font-bold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-3 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 transition duration-300 ease-in-out transform hover:scale-[1.01] active:scale-95">
